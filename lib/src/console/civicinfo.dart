part of civicinfo_us_v1_api_console;

/** Client to access the civicinfo us_v1 API */
/** An API for accessing civic information. */
class Civicinfo extends ConsoleClient {
  ...
  Civicinfo([oauth2.OAuth2Console auth]) : super(auth) {
